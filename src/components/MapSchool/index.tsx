...
const MapSchool: React.FC<InterfaceMapSchool> = ({ latitude, longitude }) => {
  return (<ContainerMapsComponent>
      <Map
        center={[longitude, latitude]}
        zoom={15}
        style={{ width: '100%', height:250, borderRadius: '20px 20px 0 0', zIndex: 1, marginTop: '1.2rem' }}
        dragging = {false}
        touchZoom={false}
        zoomControl={false}
      ...
      >
        ...
        <Marker icon={MapIconMarket} position={[longitude, latitude]}></Marker>
      </Map>
